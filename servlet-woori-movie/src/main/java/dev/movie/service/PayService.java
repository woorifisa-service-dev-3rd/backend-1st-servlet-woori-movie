...
public class PayService {
	public static Payment getPayment(String payment, String row) {
		int price = chkRowPrice(row);
		return Payment.builder().price(price).payType(payment).build();
	}
	
	public static Payment pay(MovieTime movieTime, SelectedSeatDTO seat) throws Exception {
